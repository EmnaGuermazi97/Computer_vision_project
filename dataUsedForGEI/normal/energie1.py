...
images = [imread('C:/Users/lenovo/Desktop/classification/normal/fn09/'+f) for f in files]
...
cv2.imwrite('/Users/lenovo/Desktop/classification/normalGEI/gei_fn09.png',gei)
