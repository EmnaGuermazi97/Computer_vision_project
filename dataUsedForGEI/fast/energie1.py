...
files = os.listdir('C:/Users/lenovo/Desktop/classification/fast/fq09')

images = [imread('C:/Users/lenovo/Desktop/classification/fast/fq09/'+f) for f in files]
...
cv2.imwrite('/Users/lenovo/Desktop/classification/fastGEI/gei_fq09.png',gei)
